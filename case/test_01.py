...
class Test(unittest.TestCase):
    ...
    def test01(self):
        ...
        cookies = {
            '.CNBlogsCookie': '43A0DE43EAF0EE25D667E898D8C2E915AF343D1B9E046FA6F324496D248340BF5CDC4F88E017F7A2E6FBB775D53220C4F34849BC8249483C4F771BBCDB0BCB38403A7BF46F993F713BAE0A703AF993D24E1C0D96',
        ...
        r2 = s.post(url1, headers=headers, verify=False, cookies=cookies,data=body)
        ...
        r3 = s.post(url3, headers=headers, cookies=cookies, verify=False, json=json3)
